            ...
            <div className="w-full flex-1 flex flex-row gap-4 px-4 py-4 h-full overflow-hidden">
              ...
              <div className="rounded-md w-1/2 flex flex-col h-full">
                <div className="flex-1 flex flex-col h-full">
                  ...
                  <div className="">
                    <div className="relative" id="event-dropdown">
                      ...
                      >
                        {questionSelected
                          ? questions.find((e) => e.value === questionSelected)
                              ?.label
                          : "Select a question..."}
                  ...
                  <div className="m-4 border border-base-300/30 rounded-md h-64 bg-black/5">
                    <div className="px-4 py-2 h-full overflow-y-scroll">
                      ...
                      answer answer answer answeranswer answer answer answer
                      answer answeranswer answer answer answer answer
                      answeranswer answer answer answer answer answeranswer
                      answer answer answer answer answeranswer answer answer
                      answer answer answeranswer answer answer answer answer
                      answeranswer answer answer answer answer answer answer
                      answer answer answer answer answer answer answer answer
                      answer answer answeranswer answer answer answer answer
                      answeranswer answer answer answer answer answeranswer
                      answer answer answer answer answeranswer answer answer
                ...
                <div className="flex flex-row gap-2 justify-end pr-4 pb-2">
                  <div className="px-4 py-2 border border-red-600 text-red-600 hover:border-red-700  hover:bg-red-700 hover:text-white font-bold rounded-md cursor-pointer transition-all duration-300">
                    Deny
                  </div>
