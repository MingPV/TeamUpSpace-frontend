              ...
              <div className="rounded-md w-1/2 flex flex-col h-full">
                <div className="flex-1 flex flex-col h-full">
                  ...
                  <div className="m-4 border border-base-300/30 rounded-md h-64 bg-black/5">
                    ...
                    <div
                      className="px-3 py-1 border border-base-300/30 rounded-md font-bold text-amber-700 hover:bg-black/5 cursor-pointer flex justify-center items-center mt-2 "
